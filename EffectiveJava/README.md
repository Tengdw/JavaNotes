...
#### 6. [消除过期的对象引用](./src/main/java/com/tengdw/rule/rule6.java)
...
#### 16. [复合优先于继承](./src/main/java/com/tengdw/rule/rule16.java)
...
#### 20. [类层次优于标签类](./src/main/java/com/tengdw/rule/rule20.java)
...
#### 30. [用 enum 代替 int 常量](./src/main/java/com/tengdw/rule/rule30.java)
...
#### 34. [用接口模拟可伸缩的枚举](./src/main/java/com/tengdw/rule/rule34.java)
